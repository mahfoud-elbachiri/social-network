...
const useAuth = ()=>{
    ...
    const checkAuthStatus = async ()=>{
        try {
            ...
            const response = await apiService.checkUserStatus();
    ...
    const fetchPosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (category = null, reset = false)=>{
        try {
            ...
            if (category && category !== 'all') {
                response = await apiService.getPostsByCategory(category, reset);
            } else {
                response = await apiService.getPosts(reset);
            }
...
const useComments = ()=>{
    ...
    const sendComment = async (content, postId)=>{
        try {
            setError(null);
            const response = await apiService.sendComment(content, postId);
            if (response.status) {
...
const useReactions = ()=>{
    ...
    const toggleReaction = async (contentType, contentId, reactionType)=>{
        try {
            ...
            setError(null);
            const response = await apiService.toggleReaction(contentType, contentId, reactionType);
            if (response.tocken === false) {
                throw new Error('Authentication required');
            }
            return {
...
function Home() {
    ...
    const handleScroll = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(debounce(()=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__527bbb9d._.js.map