        ...
        const checkAuth = async (retryCount = 0)=>{
            try {
                ...
                if (result.authenticated && result.user) {
                    ...
                    if (retryCount === 0) {
                        console.log('Authentication failed, retrying in 300ms...');
                ...
                if (retryCount === 0) {
                    console.log('Auth check error, retrying in 300ms...');
                    setTimeout(()=>checkAuth(1), 300);
                } else {
                    router.push('/');
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c109adf3._.js.map